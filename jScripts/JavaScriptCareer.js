...
$(document).ready(function () {
    ...
    $('#exampleFormControlSelect1').on('change', function () {
        if ($(this).find("option:selected").attr("id") == "umElFahem") {
            ...
            //$('#emailImg').hide();
            $('#emailAddress').hide();
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/FANAR.RAYAN/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddress').hide();
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/EilatYouthCenter/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#nameOfEmailAddress').html('<a href="mailto:bodner@efrat.muni.il" class="outerLinks">bodner@efrat.muni.il</a>');
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/%D7%9E%D7%98%D7%94-%D7%A6%D7%A2%D7%99%D7%A8%D7%99%D7%9D-%D7%90%D7%A4%D7%A8%D7%AA-339371922889349/" class="outerLinks" target=_blank>לעמוד הפייסבוק</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddress').hide();
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/MERKAZSTARTUP/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#nameOfEmailAddress').html('<a href="mailto:samimas69@gmail.com" class="outerLinks">samimas69@gmail.com</a>');
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/groups/1518355791796834/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#nameOfEmailAddress').html('<a href="mailto:haderay@gmail.com" class="outerLinks">haderay@gmail.com</a>');
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/%D7%98%D7%95%D7%A8%D7%91%D7%99%D7%A0%D7%94-%D7%9E%D7%A8%D7%9B%D7%96-%D7%A6%D7%A2%D7%99%D7%A8%D7%99%D7%9D-%D7%97%D7%93%D7%A8%D7%94-653718471351501/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddress').hide();
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/tzeirim.holon/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddress').hide();
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/tzeirimtiratcarmel/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddress').hide();
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/merkazyoqneam/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#nameOfEmailAddress').html('<a href="mailto:maydale@young-jerusalem.org.il" class="outerLinks">maydale@young-jerusalem.org.il</a>');
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/youngJLM/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#nameOfEmailAddress').html('<a href="mailto:info@hagag.org" class="outerLinks">info@hagag.org</a>');
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/hagag.netanya/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#nameOfEmailAddress').html('<a href="mailto:tzeirimacco@gmail.com" class="outerLinks">tzeirimacco@gmail.com</a>');
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/tzeirim.acco/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#nameOfEmailAddress').html('<a href="mailto:mazkirut@yaic.org.il" class="outerLinks">mazkirut@yaic.org.il</a>');
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/pages/%D7%9E%D7%A8%D7%9B%D7%96-%D7%A6%D7%A2%D7%99%D7%A8%D7%99%D7%9D-%D7%A2%D7%A4%D7%95%D7%9C%D7%94/1501851256720492" class="outerLinks"  target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddress').hide();
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/hapardes/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#nameOfEmailAddress').html('<a href="mailto:merkazrishon@gmail.com" class="outerLinks" >merkazrishon@gmail.com</a>');
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/merkazrishon/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#nameOfEmailAddress').html('<a href="mailto:info@haplatforma.org.il" class="outerLinks" >merkazrishon@gmail.com</a>');
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/HaplatformaRehovot/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddress').show();
            $('#nameOfEmailAddress').html('<a href="mailto:youngs@sng.org.il" class="outerLinks" >youngs@sng.org.il</a>');
            $('#nameOfacebookPage').html('<a href="https://www.facebook.com/tzeirimsng/" class="outerLinks" target=_blank>לעמוד הפייסבוק</a>');
        }
    });
    ...
    $('#exampleFormControlSelect2').on('change', function () {
        if ($(this).find("option:selected").attr("id") == "umElFahemM") {
            ...
            //$('#emailImg').hide();
            $('#emailAddressM').hide();
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/FANAR.RAYAN/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddressM').hide();
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/EilatYouthCenter/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#nameOfEmailAddressM').html('<a href="mailto:bodner@efrat.muni.il" class="outerLinks" >bodner@efrat.muni.il</a>');
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/%D7%9E%D7%98%D7%94-%D7%A6%D7%A2%D7%99%D7%A8%D7%99%D7%9D-%D7%90%D7%A4%D7%A8%D7%AA-339371922889349/" class="outerLinks" target=_blank>לעמוד הפייסבוק</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddressM').hide();
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/MERKAZSTARTUP/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#nameOfEmailAddressM').html('<a href="mailto:samimas69@gmail.com" class="outerLinks" >samimas69@gmail.com</a>');
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/groups/1518355791796834/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#nameOfEmailAddressM').html('<a href="mailto:haderay@gmail.com" class="outerLinks" >haderay@gmail.com</a>');
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/%D7%98%D7%95%D7%A8%D7%91%D7%99%D7%A0%D7%94-%D7%9E%D7%A8%D7%9B%D7%96-%D7%A6%D7%A2%D7%99%D7%A8%D7%99%D7%9D-%D7%97%D7%93%D7%A8%D7%94-653718471351501/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddressM').hide();
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/tzeirim.holon/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddressM').hide();
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/tzeirimtiratcarmel/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddressM').hide();
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/merkazyoqneam/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#nameOfEmailAddressM').html('<a href="mailto:maydale@young-jerusalem.org.il" class="outerLinks" >maydale@young-jerusalem.org.il</a>');
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/youngJLM/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#nameOfEmailAddressM').html('<a href="mailto:info@hagag.org" class="outerLinks" >info@hagag.org</a>');
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/hagag.netanya/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#nameOfEmailAddressM').html('<a href="mailto:tzeirimacco@gmail.com" class="outerLinks" >tzeirimacco@gmail.com</a>');
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/tzeirim.acco/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#nameOfEmailAddressM').html('<a href="mailto:mazkirut@yaic.org.il" class="outerLinks" >mazkirut@yaic.org.il</a>');
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/pages/%D7%9E%D7%A8%D7%9B%D7%96-%D7%A6%D7%A2%D7%99%D7%A8%D7%99%D7%9D-%D7%A2%D7%A4%D7%95%D7%9C%D7%94/1501851256720492" class="outerLinks"  target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#nameOfEmailAddressM').hide();
            $('#nameOfacebookPagMe').html('<a href="https://www.facebook.com/hapardes/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#nameOfEmailAddressM').html('<a href="mailto:merkazrishon@gmail.com" class="outerLinks" >merkazrishon@gmail.com</a>');
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/merkazrishon/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#nameOfEmailAddressM').html('<a href="mailto:info@haplatforma.org.il" class="outerLinks" >merkazrishon@gmail.com</a>');
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/HaplatformaRehovot/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }

        else if ($(this).find("option:selected").attr("id") == "shaarHanegevM") {
            $('#nameOfOrgצ').html('מרכז צעירים שער הנגב');
            $('#contactInfoM').show();
            ...
            //$('#emailImg').show();
            $('#emailAddressM').show();
            $('#nameOfEmailAddressM').html('<a href="mailto:youngs@sng.org.il" class="outerLinks" >youngs@sng.org.il</a>');
            $('#nameOfacebookPageM').html('<a href="https://www.facebook.com/tzeirimsng/" class="outerLinks" target=_blank>לעמוד הפייסבוק</a>');
        }
    });
    ...
    $('#exampleFormControlSelect3').on('change', function () {
        if ($(this).find("option:selected").attr("id") == "umElFahemM2") {
            ...
            //$('#emailImg').hide();
            $('#emailAddressM2').hide();
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/FANAR.RAYAN/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddressM2').hide();
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/EilatYouthCenter/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#nameOfEmailAddressM2').html('<a href="mailto:bodner@efrat.muni.il" class="outerLinks" >bodner@efrat.muni.il</a>');
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/%D7%9E%D7%98%D7%94-%D7%A6%D7%A2%D7%99%D7%A8%D7%99%D7%9D-%D7%90%D7%A4%D7%A8%D7%AA-339371922889349/" class="outerLinks" target=_blank>לעמוד הפייסבוק</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddressM2').hide();
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/MERKAZSTARTUP/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#nameOfEmailAddressM2').html('<a href="mailto:samimas69@gmail.com" class="outerLinks" >samimas69@gmail.com</a>');
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/groups/1518355791796834/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#nameOfEmailAddressM2').html('<a href="mailto:haderay@gmail.com" class="outerLinks" >haderay@gmail.com</a>');
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/%D7%98%D7%95%D7%A8%D7%91%D7%99%D7%A0%D7%94-%D7%9E%D7%A8%D7%9B%D7%96-%D7%A6%D7%A2%D7%99%D7%A8%D7%99%D7%9D-%D7%97%D7%93%D7%A8%D7%94-653718471351501/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddressM2').hide();
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/tzeirim.holon/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddressM2').hide();
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/tzeirimtiratcarmel/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#emailAddressM2').hide();
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/merkazyoqneam/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#nameOfEmailAddressM2').html('<a href="mailto:maydale@young-jerusalem.org.il" class="outerLinks" >maydale@young-jerusalem.org.il</a>');
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/youngJLM/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#nameOfEmailAddressM2').html('<a href="mailto:info@hagag.org" class="outerLinks" >info@hagag.org</a>');
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/hagag.netanya/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#nameOfEmailAddressM2').html('<a href="mailto:tzeirimacco@gmail.com" class="outerLinks" >tzeirimacco@gmail.com</a>');
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/tzeirim.acco/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#nameOfEmailAddressM2').html('<a href="mailto:mazkirut@yaic.org.il" class="outerLinks" >mazkirut@yaic.org.il</a>');
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/pages/%D7%9E%D7%A8%D7%9B%D7%96-%D7%A6%D7%A2%D7%99%D7%A8%D7%99%D7%9D-%D7%A2%D7%A4%D7%95%D7%9C%D7%94/1501851256720492" class="outerLinks"  target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').hide();
            $('#nameOfEmailAddressM2').hide();
            $('#nameOfacebookPagMe2').html('<a href="https://www.facebook.com/hapardes/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#nameOfEmailAddressM2').html('<a href="mailto:merkazrishon@gmail.com" class="outerLinks" >merkazrishon@gmail.com</a>');
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/merkazrishon/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }
            ...
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#nameOfEmailAddressM2').html('<a href="mailto:info@haplatforma.org.il" class="outerLinks" >merkazrishon@gmail.com</a>');
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/HaplatformaRehovot/" class="outerLinks" target=_blank>לחצו כאן</a>');
        }

        else if ($(this).find("option:selected").attr("id") == "shaarHanegevM2") {
            $('#nameOfOrgצ2').html('מרכז צעירים שער הנגב');
            $('#contactInfoM2').show();
            ...
            //$('#emailImg').show();
            $('#emailAddressM2').show();
            $('#nameOfEmailAddressM2').html('<a href="mailto:youngs@sng.org.il" class="outerLinks" >youngs@sng.org.il</a>');
            $('#nameOfacebookPageM2').html('<a href="https://www.facebook.com/tzeirimsng/" class="outerLinks" target=_blank>לעמוד הפייסבוק</a>');
        }
    });
